...
## [0.18.0](https://github.com/dadrus/heimdall/compare/v0.17.0...v0.18.0) (2026-09-26)


### ⚠ BREAKING CHANGES

* Communication settings for exposed services restructured ([#3546](https://github.com/dadrus/heimdall/issues/3546))
* `Outputs` adopted structured result format ([#3505](https://github.com/dadrus/heimdall/issues/3505))
* `forward_response_headers_to_upstream` removed from `remote` authorizer ([#3504](https://github.com/dadrus/heimdall/issues/3504))
* Rule `match` configuration restructured for protocol-specific matching ([#3357](https://github.com/dadrus/heimdall/issues/3357))
* `basic_auth_authenticator` verifies Argon2id PHC password hashes instead of plain passwords ([#3238](https://github.com/dadrus/heimdall/issues/3238))
* New secret management abstraction ([#3238](https://github.com/dadrus/heimdall/issues/3238))
* `certificate.expiry` metric changed from UpDownCounter to Gauge ([#3088](https://github.com/dadrus/heimdall/issues/3088))
...
* `basic_auth_authenticator` verifies Argon2id PHC password hashes instead of plain passwords ([#3238](https://github.com/dadrus/heimdall/issues/3238)) ([b0716eb](https://github.com/dadrus/heimdall/commit/b0716ebc564ad2205179a39978b795f5db4870c5))
* `jwt` and `oauth2_introspection` authenticators updated to support DPoP ([#3231](https://github.com/dadrus/heimdall/issues/3231)) ([5caff81](https://github.com/dadrus/heimdall/commit/5caff81303d51a9d2cd7e943ccc01ef3a5d06b4a))
...
* Configurable graceful application shutdown ([#3546](https://github.com/dadrus/heimdall/issues/3546)) ([4e12733](https://github.com/dadrus/heimdall/commit/4e12733a8e35cd690030e3d4c62583e1a60331c8))
* Connection and request admission limits for exposed services ([#3546](https://github.com/dadrus/heimdall/issues/3546)) ([4e12733](https://github.com/dadrus/heimdall/commit/4e12733a8e35cd690030e3d4c62583e1a60331c8))
* Explicit `h2c` upstream support ([#3546](https://github.com/dadrus/heimdall/issues/3546)) ([4e12733](https://github.com/dadrus/heimdall/commit/4e12733a8e35cd690030e3d4c62583e1a60331c8))
...
* Human friendly error messages for configuration validation errors ([#3238](https://github.com/dadrus/heimdall/issues/3238)) ([b0716eb](https://github.com/dadrus/heimdall/commit/b0716ebc564ad2205179a39978b795f5db4870c5))
* Loading secrets from files ([#3238](https://github.com/dadrus/heimdall/issues/3238)) ([b0716eb](https://github.com/dadrus/heimdall/commit/b0716ebc564ad2205179a39978b795f5db4870c5))
...
* New `generic` error handler for custom error responses ([#3224](https://github.com/dadrus/heimdall/issues/3224)) ([d35d857](https://github.com/dadrus/heimdall/commit/d35d85797f16a7bcfb26348a12e772c6962eee75))
...
* New metrics and spans ([#3070](https://github.com/dadrus/heimdall/issues/3070)) ([e37e246](https://github.com/dadrus/heimdall/commit/e37e246fe015daec0afc993cee9be1876c71bfd7))
* New secret management abstraction ([#3238](https://github.com/dadrus/heimdall/issues/3238)) ([b0716eb](https://github.com/dadrus/heimdall/commit/b0716ebc564ad2205179a39978b795f5db4870c5))
...
* RFC-compliant authentication error signaling ([#3226](https://github.com/dadrus/heimdall/issues/3226)) ([5c0f395](https://github.com/dadrus/heimdall/commit/5c0f3950272d74e6b5080ba6cda0b1a28f6bf910))
...
* Usage of key material from JWKS files ([#3303](https://github.com/dadrus/heimdall/issues/3303)) ([f2c9a26](https://github.com/dadrus/heimdall/commit/f2c9a26e8a8972e61e14b92420408512e64abcb1))
* Usage of secrets within rules allows service specific API-Keys ([#3238](https://github.com/dadrus/heimdall/issues/3238)) ([b0716eb](https://github.com/dadrus/heimdall/commit/b0716ebc564ad2205179a39978b795f5db4870c5))
...
* `certificate.expiry` metric changed from UpDownCounter to Gauge ([#3088](https://github.com/dadrus/heimdall/issues/3088)) ([1faba9e](https://github.com/dadrus/heimdall/commit/1faba9e4160bd7ab3240cf6aa418e21bfef3401a))
* `forward_response_headers_to_upstream` removed from `remote` authorizer ([#3504](https://github.com/dadrus/heimdall/issues/3504)) ([d06927a](https://github.com/dadrus/heimdall/commit/d06927a71c202f41241afce991c4a3e6c1c92e54))
...
* `Outputs` adopted structured result format ([#3505](https://github.com/dadrus/heimdall/issues/3505)) ([7cc5361](https://github.com/dadrus/heimdall/commit/7cc53615b4d1b26449a42c155a27e28f982991e9))
...
* Communication settings for exposed services restructured ([#3546](https://github.com/dadrus/heimdall/issues/3546)) ([4e12733](https://github.com/dadrus/heimdall/commit/4e12733a8e35cd690030e3d4c62583e1a60331c8))
...
* Rule `match` configuration restructured for protocol-specific matching ([#3357](https://github.com/dadrus/heimdall/issues/3357)) ([99c39c8](https://github.com/dadrus/heimdall/commit/99c39c86abf9a10a0cbe7198c50613e4f1e92f23))
...
* Reverse proxy and transport infrastructure reused across requests ([#3546](https://github.com/dadrus/heimdall/issues/3546)) ([4e12733](https://github.com/dadrus/heimdall/commit/4e12733a8e35cd690030e3d4c62583e1a60331c8))
...
* New guide showcasing DPoP-bound access tokens ([#3231](https://github.com/dadrus/heimdall/issues/3231)) ([5caff81](https://github.com/dadrus/heimdall/commit/5caff81303d51a9d2cd7e943ccc01ef3a5d06b4a))
...
* Harden `Host`, `Forwarded` and `X-Forwarded-For` header usage ([#3315](https://github.com/dadrus/heimdall/issues/3315)) ([e183d45](https://github.com/dadrus/heimdall/commit/e183d4548f7cc9327047c64de08a207abd5c3d07))
