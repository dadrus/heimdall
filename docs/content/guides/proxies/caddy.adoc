...
In most cases, you need to configure heimdall to trust your Caddy instances by setting link:{{< relref "/docs/operations/services.adoc#_trusted_proxies" >}}[trusted_proxies]. Exceptions are detailed in the sections below.
