...
3. If you have configured `envoyExtAuthzGrpc` as shown above, deploy the following `EnvoyFilter` resource to correct the cluster configuration that Istio sets up for the Heimdall service.
+
[source, yaml]
----
