...
+
Enables or disables backtracking within the rule set (see link:{{< relref "#_rule_matching_specificity_backtracking" >}}[Rule Matching Specificity & Backtracking] for more details). Defaults to `true`.
...
** *`backtrackingEnabled`*: _boolean_ (optional)
+
Enables or disables backtracking within the rule set (see link:{{< relref "#_rule_matching_specificity_backtracking" >}}[Rule Matching Specificity & Backtracking] for more details). Defaults to `true`.
