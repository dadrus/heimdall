...
For guidance on how to keep mechanism definitions reusable and how to separate
stable mechanism behaviour from rule-specific inputs, see
link:{{< relref "/docs/mechanisms/mechanism_design.adoc" >}}[Designing Mechanism Definitions].
