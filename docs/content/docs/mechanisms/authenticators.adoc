...
* *`error_signaling`*: _link:{{< relref "/docs/configuration/types.adoc#_bearer_token_usage_error_signaling" >}}[Bearer Token Usage Error Signaling]_ (optional, overridable)
+
Configures whether failures should be signaled using the `WWW-Authenticate` response header according to https://www.rfc-editor.org/rfc/rfc6750[RFC 6750].
