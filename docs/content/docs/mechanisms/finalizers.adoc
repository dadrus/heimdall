...
In a rule making use of the finalizer defined above, you could add further custom claims, which would be placed within the `"extra"` claim without the need to redefine the `claims` property, like .e.g shown below.
