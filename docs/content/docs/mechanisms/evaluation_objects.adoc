---
title: "Evaluation Objects & Beyond"
...
menu:
  docs:
    weight: 2
    parent: "Mechanisms"
description: The dynamic nature of mechanisms is given by the ability to work on different objects and making use of templates and scripts to implement different use cases.
---
