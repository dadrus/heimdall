...
A fully working example with Traefik is shown in the link:{{< relref "../getting_started/decision_service_quickstart.adoc#_run_integrated" >}}[Decision Service Quickstart].
