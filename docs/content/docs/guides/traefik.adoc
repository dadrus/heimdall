...
A fully working example with Traefik is shown in the link:{{< relref "/docs/quickstarts/decision_service_quickstart.adoc#_run_integrated" >}}[Decision Service Quickstart] and is also available on https://github.com/dadrus/heimdall/tree/main/examples[GitHub].
