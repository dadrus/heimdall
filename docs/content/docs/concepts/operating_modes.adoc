...
Starting heimdall in this mode happens via the `serve decision` command. Head over to the description of link:{{< relref "/docs/operations/cli.adoc" >}}[CLI] as well as to link:{{< relref "/docs/operations/services.adoc#_main_service" >}}[corresponding configuration options] for more details.
...
Starting heimdall in this mode happens via the `serve proxy` command. Head over to the description of link:{{< relref "/docs/operations/cli.adoc" >}}[CLI] as well as to link:{{< relref "/docs/operations/services.adoc#_main_service" >}}[main service configuration options] for more details.
