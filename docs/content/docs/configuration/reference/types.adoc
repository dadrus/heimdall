...
Depending on the configured content type for the request the result might look like
[source, text]
----
idToken=<whatever the token value is>
----
if the content type was set to `application/x-www-form-urlencoded`, or
