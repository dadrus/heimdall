...
| `cache_ttl`                  | *[Duration]({{< ref "configuration_types.md#duration" >}})*                                     | no        | yes         | How long to cache the response. If not set, response caching if disabled.                                                                                                                                                                                                                                                                                                             |
...
| `assertions`             | *[Assertions]({{< ref "configuration_types.md#assertions" >}})* | yes       | yes         | Configures the required claim assertions.                                                                                                                                                                                                                                                                                                                                                  |
...
| jwt_from      | *[Authentication Data Source]({{< ref "configuration_types.md#authentication-data-source" >}})* | no        | no          | Where to get the access token from. If not set, this authenticator tries to retrieve it from the `Authorization` header and the `access_token` query paramter.                                                                                                                                                         |
| assertions    | *[Assertions]({{< ref "configuration_types.md#assertions" >}})*                                 | yes       | yes         | Configures the required claim assertions.                                                                                                                                                                                                                                                                              |
