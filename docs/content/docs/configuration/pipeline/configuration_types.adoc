...
+
Since different authentication system use different representations for time strings, this property allows the definition of the format used by the authentication system. Defaults to Unix Epoch time stamp.
