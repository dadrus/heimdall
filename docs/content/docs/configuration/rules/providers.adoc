...
This provider doesn't need any additional configuration for a rule set. So the contents of files are as described in link:{{< relref "configuration.adoc#_rule_set" >}}[Rule Sets].
