...
As with the link:{{< relref "/docs/configuration/getting_started/configuration_introduction.adoc#_configuration_file" >}}[static configuration file], the definitions in the rule sets can make use of environment variables using Bash syntax.
