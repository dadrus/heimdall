...
+
The key store containing the cryptographic material. At least one private key and the corresponding certificate must be present. Supports watching for secrets rotation.
