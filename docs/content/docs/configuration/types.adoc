...
+
NOTE: Replay detection is performed on a best-effort basis and depends on the consistency guarantees of the configured link:{{< relref "/docs/operations/cache.adoc" >}}[cache backend].
...
* *`include_dpop_algorithms`*: _boolean_ (optional)
+
