...
* *`timeout`*: _link:{{< relref "configuration_types.adoc#timeout" >}}[Timeout]_ (optional)
+
...
* *`cors`*: _link:{{< relref "configuration_types.adoc#cors" >}}[CORS]_ (optional)
+
...
* *`tls`*: _link:{{< relref "configuration_types.adoc#tls" >}}[TLS]_ (optional)
+
