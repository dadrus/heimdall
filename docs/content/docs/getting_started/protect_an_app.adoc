...
----
<1> These lines configure heimdall to use our config and rule file and to run in proxy operation mode.
...
<3> These lines configure heimdall to use our config and rule file and to run in decision operation mode.
