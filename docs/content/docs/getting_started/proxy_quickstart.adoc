...
heimdall_1  | 8:26AM INF Management endpoint starts listening on: :4457
heimdall_1  | 8:26AM INF Prometheus endpoint starts listening on: :9000
heimdall_1  | 8:26AM INF Proxy endpoint starts listening on: :4455
----
