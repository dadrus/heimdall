...
* The https://go.dev/dl/[Go] programming language >= 1.26
...
[source, bash]
----
$ docker pull dadrus/heimdall:0.17.17 && docker run dadrus/heimdall:0.17.17 --version
heimdall version v0.17.17
----
