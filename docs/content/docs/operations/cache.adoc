...
+
Herewith you can define the credentials to be used for connection purposes to the Redis DB/Cluster. The credentials object must include a `username` (optional) and a `password` entries:
+
[source, yaml]
----
