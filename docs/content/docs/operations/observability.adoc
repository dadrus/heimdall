...
* Information about the decision and proxy requests handled, including the total amount and duration of http and grpc requests by status code and method, as well as information about requests in progress.
