...
// Add provides a mock function for the type ObserverMock
func (_mock *ObserverMock) Add(sup certificate.Supplier) {
	_mock.Called(sup)
	return
}
...
func (_c *ObserverMock_Add_Call) Run(run func(sup certificate.Supplier)) *ObserverMock_Add_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 certificate.Supplier
		if args[0] != nil {
			arg0 = args[0].(certificate.Supplier)
		}
		run(
			arg0,
		)
