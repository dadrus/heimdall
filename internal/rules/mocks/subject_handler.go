...
func (_c *SubjectHandlerMock_Execute_Call) Run(run func(ctx heimdall.RequestContext, sub identity.Subject)) *SubjectHandlerMock_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *SubjectHandlerMock_Execute_Call) RunAndReturn(run func(ctx heimdall.RequestContext, sub identity.Subject) error) *SubjectHandlerMock_Execute_Call {
	_c.Call.Return(run)
	return _c
}
