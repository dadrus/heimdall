...
func (_mock *PrincipalCreatorMock) Execute(ctx heimdall.RequestContext, sub identity.Subject) error {
...
func (_c *PrincipalCreatorMock_Execute_Call) Run(run func(ctx heimdall.RequestContext, sub identity.Subject)) *PrincipalCreatorMock_Execute_Call {
...
func (_c *PrincipalCreatorMock_Execute_Call) RunAndReturn(run func(ctx heimdall.RequestContext, sub identity.Subject) error) *PrincipalCreatorMock_Execute_Call {
	_c.Call.Return(run)
	return _c
}
