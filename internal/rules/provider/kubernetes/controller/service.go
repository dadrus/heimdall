...
import (
	...
	"github.com/dadrus/heimdall/internal/rules/provider/kubernetes/controller/conversion"
	"github.com/dadrus/heimdall/internal/rules/provider/kubernetes/controller/validation"
...
func newService(
	...
	hc := alice.New(
		...
		otelmetrics.New(
			otelmetrics.WithSubsystem("admission webhook"),
