...
func (_m *ClientMock) RuleSetRepository(namespace string) v1beta1.RuleSetRepository {
	...
	if rf, ok := ret.Get(0).(func(string) v1beta1.RuleSetRepository); ok {
		r0 = rf(namespace)
	} else {
		if ret.Get(0) != nil {
...
func (_c *ClientMock_RuleSetRepository_Call) Return(_a0 v1beta1.RuleSetRepository) *ClientMock_RuleSetRepository_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ClientMock_RuleSetRepository_Call) RunAndReturn(run func(string) v1beta1.RuleSetRepository) *ClientMock_RuleSetRepository_Call {
	_c.Call.Return(run)
	return _c
}
