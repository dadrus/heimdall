...
func (_m *RuleSetRepositoryMock) List(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, v1.ListOptions) (runtime.Object, error)); ok {
		return rf(ctx, opts)
	}
	if rf, ok := ret.Get(0).(func(context.Context, v1.ListOptions) runtime.Object); ok {
		r0 = rf(ctx, opts)
	} else {
		if ret.Get(0) != nil {
...
func (_c *RuleSetRepositoryMock_List_Call) Return(_a0 runtime.Object, _a1 error) *RuleSetRepositoryMock_List_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RuleSetRepositoryMock_List_Call) RunAndReturn(run func(context.Context, v1.ListOptions) (runtime.Object, error)) *RuleSetRepositoryMock_List_Call {
	_c.Call.Return(run)
	return _c
}
