...
func (_m *ClientMock) RuleSetRepository(namespace string) v1alpha4.RuleSetRepository {
	...
	var r0 v1alpha4.RuleSetRepository
	if rf, ok := ret.Get(0).(func(string) v1alpha4.RuleSetRepository); ok {
		r0 = rf(namespace)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(v1alpha4.RuleSetRepository)
		}
	}
...
func (_c *ClientMock_RuleSetRepository_Call) RunAndReturn(run func(string) v1alpha4.RuleSetRepository) *ClientMock_RuleSetRepository_Call {
	_c.Call.Return(run)
	return _c
}
