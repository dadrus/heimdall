...
func (_mock *ExecutorMock) Execute(ctx heimdall.Context) (rule.Backend, error) {
...
func (_c *ExecutorMock_Execute_Call) RunAndReturn(run func(ctx heimdall.Context) (rule.Backend, error)) *ExecutorMock_Execute_Call {
	_c.Call.Return(run)
	return _c
}
