...
// MatchesMethod provides a mock function with given fields: method
func (_m *RuleMock) MatchesMethod(method string) bool {
	ret := _m.Called(method)

	if len(ret) == 0 {
		panic("no return value specified for MatchesMethod")
	}
...
//   - method string
func (_e *RuleMock_Expecter) MatchesMethod(method interface{}) *RuleMock_MatchesMethod_Call {
	return &RuleMock_MatchesMethod_Call{Call: _e.mock.On("MatchesMethod", method)}
}

func (_c *RuleMock_MatchesMethod_Call) Run(run func(method string)) *RuleMock_MatchesMethod_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
// MatchesURL provides a mock function with given fields: match
func (_m *RuleMock) MatchesURL(match *url.URL) bool {
	ret := _m.Called(match)

	if len(ret) == 0 {
		panic("no return value specified for MatchesURL")
	}
...
//   - match *url.URL
func (_e *RuleMock_Expecter) MatchesURL(match interface{}) *RuleMock_MatchesURL_Call {
	return &RuleMock_MatchesURL_Call{Call: _e.mock.On("MatchesURL", match)}
}

func (_c *RuleMock_MatchesURL_Call) Run(run func(match *url.URL)) *RuleMock_MatchesURL_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*url.URL))
	})
	return _c
