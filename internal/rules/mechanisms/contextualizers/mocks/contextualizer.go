...
func (_m *ContextualizerMock) Execute(ctx heimdall.Context, sub subject.Subject) error {
...
func (_c *ContextualizerMock_Execute_Call) Run(run func(ctx heimdall.Context, sub subject.Subject)) *ContextualizerMock_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ContextualizerMock_Execute_Call) RunAndReturn(run func(heimdall.Context, subject.Subject) error) *ContextualizerMock_Execute_Call {
	_c.Call.Return(run)
	return _c
}
