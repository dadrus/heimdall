...
func (_m *AuthorizerMock) Execute(ctx heimdall.RequestContext, sub *subject.Subject) error {
...
func (_m *AuthorizerMock) WithConfig(stepID string, config map[string]interface{}) (authorizers.Authorizer, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, map[string]interface{}) (authorizers.Authorizer, error)); ok {
		return rf(stepID, config)
	}
	if rf, ok := ret.Get(0).(func(string, map[string]interface{}) authorizers.Authorizer); ok {
		r0 = rf(stepID, config)
	} else {
		if ret.Get(0) != nil {
...
func (_c *AuthorizerMock_WithConfig_Call) Run(run func(stepID string, config map[string]interface{})) *AuthorizerMock_WithConfig_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *AuthorizerMock_WithConfig_Call) RunAndReturn(run func(string, map[string]interface{}) (authorizers.Authorizer, error)) *AuthorizerMock_WithConfig_Call {
	_c.Call.Return(run)
	return _c
}
