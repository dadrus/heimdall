...
// UnifierMock_ID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ID'
type UnifierMock_ID_Call struct {
	*mock.Call
}

// ID is a helper method to define mock.On call
func (_e *UnifierMock_Expecter) ID() *UnifierMock_ID_Call {
	return &UnifierMock_ID_Call{Call: _e.mock.On("ID")}
}
...
func (_c *UnifierMock_ID_Call) Return(_a0 string) *UnifierMock_ID_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *UnifierMock_ID_Call) RunAndReturn(run func() string) *UnifierMock_ID_Call {
	_c.Call.Return(run)
	return _c
}
