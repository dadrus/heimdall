...
func (_m *AuthenticatorMock) ContinueOnError() bool {
	ret := _m.Called()
...
// AuthenticatorMock_ContinueOnError_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ContinueOnError'
type AuthenticatorMock_ContinueOnError_Call struct {
	*mock.Call
}

// ContinueOnError is a helper method to define mock.On call
func (_e *AuthenticatorMock_Expecter) ContinueOnError() *AuthenticatorMock_ContinueOnError_Call {
	return &AuthenticatorMock_ContinueOnError_Call{Call: _e.mock.On("ContinueOnError")}
}

func (_c *AuthenticatorMock_ContinueOnError_Call) Run(run func()) *AuthenticatorMock_ContinueOnError_Call {
...
func (_c *AuthenticatorMock_ContinueOnError_Call) Return(_a0 bool) *AuthenticatorMock_ContinueOnError_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *AuthenticatorMock_ContinueOnError_Call) RunAndReturn(run func() bool) *AuthenticatorMock_ContinueOnError_Call {
	_c.Call.Return(run)
	return _c
}

// Execute provides a mock function with given fields: ctx, sub
func (_m *AuthenticatorMock) Execute(ctx heimdall.Context, sub subject.Subject) error {
...
func (_c *AuthenticatorMock_Execute_Call) Run(run func(ctx heimdall.Context, sub subject.Subject)) *AuthenticatorMock_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *AuthenticatorMock_Execute_Call) Return(_a0 error) *AuthenticatorMock_Execute_Call {
	_c.Call.Return(_a0)
	return _c
}
