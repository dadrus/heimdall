...
func (_m *AuthenticatorMock) WithConfig(stepID string, config map[string]interface{}) (authenticators.Authenticator, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, map[string]interface{}) (authenticators.Authenticator, error)); ok {
		return rf(stepID, config)
	}
	if rf, ok := ret.Get(0).(func(string, map[string]interface{}) authenticators.Authenticator); ok {
		r0 = rf(stepID, config)
	} else {
		if ret.Get(0) != nil {
...
func (_c *AuthenticatorMock_WithConfig_Call) Run(run func(stepID string, config map[string]interface{})) *AuthenticatorMock_WithConfig_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *AuthenticatorMock_WithConfig_Call) RunAndReturn(run func(string, map[string]interface{}) (authenticators.Authenticator, error)) *AuthenticatorMock_WithConfig_Call {
	_c.Call.Return(run)
	return _c
}
