...
func (_mock *AuthenticatorMock) Execute(ctx heimdall.RequestContext, sub identity.Subject) error {
...
func (_e *AuthenticatorMock_Expecter) Execute(ctx interface{}, sub interface{}) *AuthenticatorMock_Execute_Call {
	return &AuthenticatorMock_Execute_Call{Call: _e.mock.On("Execute", ctx, sub)}
}

func (_c *AuthenticatorMock_Execute_Call) Run(run func(ctx heimdall.RequestContext, sub identity.Subject)) *AuthenticatorMock_Execute_Call {
...
func (_c *AuthenticatorMock_Execute_Call) Return(err error) *AuthenticatorMock_Execute_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *AuthenticatorMock_Execute_Call) RunAndReturn(run func(ctx heimdall.RequestContext, sub identity.Subject) error) *AuthenticatorMock_Execute_Call {
	_c.Call.Return(run)
	return _c
}
