...
func (s *RequestContext) QueryParameter(name string) string       { return s.c.Query(name) }
func (s *RequestContext) FormParameter(name string) string        { return s.c.FormValue(name) }
