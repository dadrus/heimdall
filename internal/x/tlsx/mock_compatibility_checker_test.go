...
type mockConstructorTestingTnewCompatibilityCheckerMock interface {
	mock.TestingT
	Cleanup(func())
}
...
func newCompatibilityCheckerMock(t mockConstructorTestingTnewCompatibilityCheckerMock) *compatibilityCheckerMock {
