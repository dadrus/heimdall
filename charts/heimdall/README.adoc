...
If you want to have detailed CPU & memory profiling information, you can enable the profiling service and let your APM scrape the corresponding pprof data. For [Phlare](https://grafana.com/docs/phlare), the corresponding annotations are set if the profiling service is enabled.
